...
export default function UserProfile() {
  ...
  const { data } = await api.get(`/users/${routeUsername}`, {
      ...
      console.log('User data received:', {
        ...
        bio_details: {
          value: data.bio,
          type: typeof data.bio,
          length: data.bio?.length,
          isEmpty: data.bio === '',
          isNull: data.bio === null,
          isUndefined: data.bio === undefined,
          stringified: JSON.stringify(data.bio)
        }
      });
              ...
              <div className="mt-3 bg-surface-light dark:bg-surface-dark p-4 rounded">
                ...
                <p className="text-[var(--text-secondary)] text-sm">
                  ...
                  <span className="block text-xs text-gray-500 mb-2">
                    [Debug] Bio Info:
                    <br />- Value: {JSON.stringify(userData.bio)}
                    <br />- Type: {typeof userData.bio}
                    <br />- Length: {(userData.bio || '').length}
                    <br />- Is Empty: {String(userData.bio === '')}
                    <br />- Is Null: {String(userData.bio === null)}
                    <br />- Is Undefined: {String(userData.bio === undefined)}
                  </span>
                  {bioContent}
                </p>
              </div>
