...
router.post('/avatar/test', userController.avatarUploadMiddleware, userController.uploadAvatar);
router.post('/avatar/debug', userController.avatarUploadMiddleware, userController.avatarDebug);
